...
def resnet101(pretrained=True, channel= 3, **kwargs):
    print('=======> we have entered Resnet101 network...')
    ...
    if pretrained:
       ...
       pretrain_dict = torch.load('/home/zhuc/pytorch/dynamic_image/pytorch-DI/data/DI_Resnet101/resnet101.pth')                # modify pretrain code
       model_dict = model.state_dict()
       model_dict=weight_transform(model_dict, pretrain_dict, channel)
       model.load_state_dict(model_dict)
